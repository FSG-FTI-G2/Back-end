...
from app.providers.LLM import LLMProvider, LLMModel, DEFAULT_MODEL
...
def generate(question_input, role_input, llm_model):
    ...
    response = llm_providers.response(
...
test_folder_path = "P:\\FA24\\test_folder"

class TestApp(unittest.TestCase):

    def setUp(self):
        self.model = SentenceTransformer('avsolatorio/GIST-Embedding-v0')
    ...
    def test_generate(self):
        ...
        try:
            ...
            self.assertGreater(len(response), 0, "Response length should be greater than 0")
        except Exception as e:
    ...
    def test_similarity_on_dataframe(self):
        ...
        for i in range(len(df)):
            ...
            answer_llm = generate(question_input=question, role_input="student", llm_model="gemini")
